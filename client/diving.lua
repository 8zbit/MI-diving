...
AddEventHandler('qb-diving:client:NewLocations', function()
    ESX.TriggerServerCallback('qb-diving:server:GetDivingConfig', function(Config, Area)
                            ...
                            if not CoralLocation.PickedUp then
                                ...
                                if CoralDistance <= 1.5 then
                                    ...
                                    if IsControlJustPressed(0, Keys["E"]) then
                                        ...
                                        Progressbar("take_coral", "Collecting coral..", times * 1000, false, true, {
    ...
    if bool then
        ...
        if currentGear.enabled then
            GearAnim()
                ...
                ClearPedTasks(GetPlayerPed(-1))
                exports['mythic_notify']:DoHudText('inform', 'You took your wetsuit off')
        else
            exports['mythic_notify']:DoHudText('inform', 'You are not wearing a diving gear..')
        end
    end
end)
